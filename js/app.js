...
function comprarCurso(e){
    ...
    if(e.target.classList.contains("agregar-carrito")){
        ...
        // enviamos el curso seleccionado para mostrar sus datos
...
function guardarCursoLocalStorage(curso) {
    let cursos;
    // Toma el valor de un array con datos de LocalStorage o vacio
...
function eliminarCursoLocalStorage(curso) {
    ...
    cursosLS = obtenerCursosLocalStorage();
    // Iteramos compranado el ID del curso borrado con LocalStorage
    cursosLS.forEach(function(cursoLS, index){
        if(cursoLS.id === curso) {
            cursosLS.splice(index,1);
        }
    });
    // Añadimos el arreglo actual con 
